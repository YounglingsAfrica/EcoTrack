...
const Services = () => {
    return (
        <section id='subscriptions' className='mb-40 max-w-full'>
            <div>
                <h1 className='text-center text-6xl md:text-7xl font-thin mb-20 text-gradient2 mt-20'>
                    Subscriptions
                </h1>
            </div>
            {/* container start */}
            <div className='flex flex-wrap justify-center items-center gap-6'>
                {/* first */}
                <div 
                    className="flex-grow my-auto p-2 border-white rounded-2xl bg-white border max-w-[24rem] mx-auto mt-20 text-center divide-y-2 divide-dotted divide-primaryGreen50"
                ...
                {/* second */}
                <div 
                    className="flex-grow p-8 bg-gradient-to-bl from-black to-primaryGreen rounded-2xl max-w-[24rem] mx-auto divide-y-2 divide-dotted divide-white mt-16"
                    style={{boxShadow: "rgba(45, 50, 130, 0.15) 0px 12px 16px -4px, rgba(45, 50, 130, 0.15) 0px 4px 6px -2px"}}
                >
                    <div className="p-6">
                        <div className="text-center">
                ...
                {/* third */}
                <div 
                    className="flex-basis[1/3] my-auto p-2 border-white bg-white rounded-2xl border divide-y-2 divide-dotted divide-primaryGreen50 max-w-[24rem] mx-auto mt-20"
                    style={{boxShadow: "rgba(45, 50, 130, 0.15) 0px 12px 16px -4px, rgba(45, 50, 130, 0.15) 0px 4px 6px -2px"}}
                >
