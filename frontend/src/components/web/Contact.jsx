...
const Contact = () => {
    return (
        <section id='contact' className='pt-40 mb-20'>
            <h1 className='text-center text-7xl font-thin max-w-full mb-28 text-gradient2 mt-20 pb-10'>
                Contact Us
            </h1>
            <div className='flex justify-center'>
                <div className='w-1/2'>
                    <div className='flex justify-start items-center flex-col'>
                        <h2 
                            className='max-w-md leading-snug text-center text-5xl font-semibold mb-20 text-white mt-20 pb-10'
                        >
                ...
                <div className='w-1/2'>
                    <div className='bg-[#F0F0F0] w-[650px] h-[700px] rounded-3xl p-6 px-14'>
                        <div>
                            ...
                            <input
                                className='border-b-2 border-gray-400 bg-[#F0F0F0] w-full mb-12 focus:outline-none focus:border-primaryGreen'
                                type="text" 
                            ...
                            />
                            <textarea
                                className='border-b-2 border-gray-400 bg-[#F0F0F0] w-full mb-20 focus:outline-none focus:border-primaryGreen resize-none'
                                type="text" 
                                placeholder='Your message'
                            />
                        </div>
                            <button 
                                className='flex items-center text-center justify-center px-6 w-56 h-14 text-white rounded-xl bg-gradient-to-r from-black to-primaryGreen mt-10 mx-auto shadow-right-bottom'
                            >
                                <svg className='h-auto w-6 mr-4' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M1.94631 9.31555C1.42377 9.14137 1.41965 8.86034 1.95706 8.6812L21.0433 2.31913C21.5717 2.14297 21.8748 2.43878 21.7268 2.95706L16.2736 22.0433C16.1226 22.5718 15.8179 22.5901 15.5946 22.0877L12.0002 14.0002L18.0002 6.00017L10.0002 12.0002L1.94631 9.31555Z" fill="rgba(255,255,255,1)"></path></svg>Send Message
                            </button>
                    </div>
                </div>
            </div>
